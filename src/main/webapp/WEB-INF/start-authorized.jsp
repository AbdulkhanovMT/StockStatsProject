    ...
    <section class="py-4 py-xl-5" style="padding-bottom: 0px;margin-bottom: 132px;">
        <div class="container">
            <div class="text-center p-4 p-lg-5">
                ...
                <h1 class="fw-bold mb-4">STATISTICS AND STOCK CONTROL<br>FOR ONLINE SELLERS</h1><button class="btn btn-primary fs-5 me-2 py-2 px-4" type="button" onclick="/login">Login</button><button class="btn btn-light fs-5 py-2 px-4" type="button">Signup</button>
            </div>
        </div>
    </section>
