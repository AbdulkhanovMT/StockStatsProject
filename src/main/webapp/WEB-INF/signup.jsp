...
<nav class="navbar navbar-light navbar-expand-md py-3">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span
            ...
            class="bi bi-bezier">
                    ...
                    </svg></span><span class="fs-1" href="${pageContext.request.contextPath}/start">StockStats</span></a>
        <button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span
                class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-2">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"></li>
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/start">Start page</a></li>
                <li class="nav-item"></li>
            </ul>
            <a class="btn btn-primary ms-md-2" role="button" href="${pageContext.request.contextPath}/login">Login</a>
        </div>
    </div>
</nav>
...
<section class="position-relative py-4 py-xl-5" style="padding-top: 10px;">
    <div class="container">
        <div class="row d-flex justify-content-center" style="margin-right: 10px;margin-left: 10px;padding-top: 0px;">
            <div class="col-md-6 col-xl-4" style="padding: 0px 0px;height: 750px;">
                <div class="card mb-5">
                    <div class="card-body d-flex flex-column align-items-center" style="height: 550px;">
                        ...
                        <form class="text-center" method="post" style="height: 500px;">
                            <div class="mb-3"><input class="form-control" type="email" name="name" placeholder="Name">
                            </div>
                            <input class="form-control" type="email" name="last name" placeholder="Last name">
                            <div class="mb-3"></div>
                            <input class="form-control" type="text" name="name of organization"
                            ...
                            <div class="alert alert-success" role="alert"
                                 style="background: var(--bs-light);color: var(--bs-black);"><span><strong>Confirm password</strong></span>
                            </div>
                            <div class="mb-3"></div>
                        </form>
                    </div>
