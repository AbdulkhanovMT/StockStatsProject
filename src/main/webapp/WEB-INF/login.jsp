...
<section class="position-relative py-4 py-xl-5">
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span
                ...
                class="bi bi-bezier">
                        ...
                        </svg></span><span class="fs-1" onclick="window.location.href='${pageContext.request.contextPath}/start'">StockStats</span></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                ...
                <a class="btn btn-primary ms-md-2" role="button" href="${pageContext.request.contextPath}/signup">Signup</a>
            </div>
        </div>
    </nav>
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Log in</h2>
                <p class="w-lg-50">Please log in to get access to the service</p>
            </div>
        </div>
                ...
                <div class="card mb-5">
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <form class="text-center" method="post">
                            <div class="mb-3"><input class="form-control" type="email" name="email" placeholder=
                            <c:choose>
                                <c:when test="${session.getAttribute('user') != null}">${session.getAttribute('user')}</c:when>
    ...
    <footer class="text-center py-4" style="margin: 70px;">
        <div class="container">
